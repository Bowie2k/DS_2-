...
# person_data_parser(name="Aiyyskhan", age=32, prog_lang='Python')
# person_data_parser(name="Mike", age=25)


# вариант 3. Функция, которые возвращает значение
...
# возвращение нескольких функции
def func_10(a, b):
    res_1 = a ** 2
    res_2 = b ** 3
    return res_1, res_2
...
# присвоение нескольких возвращаемых функцией значений в переменной
...
def decorator_1(func):
    '''
    func : аргумент, которому присваиваетсмя объект целевой функции 
    '''
